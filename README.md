...
- **Gemini Search Grounding:** Leveraged Google Search via Gemini API to find real individuals and company URLs when scraping fails.
- **Hallucination Filtering:** Implemented heuristics to detect and filter out generic/fake contacts (e.g., "John Doe") generated by LLMs.
- **Multi-Source Extraction:** Enrichment now cross-references company homepage, LinkedIn, and external search to maximize data quality.
